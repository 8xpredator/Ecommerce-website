...
//echo $num;
if($num=mysqli_fetch_array($query))
{
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li><b>/</b></li>
				<li class='active'><b>Authentication</b></li>
			</ul>
...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle">create a new account</h4><br>
	<p class="text title-tag-line">Create your own Shopping account.</p><br>
	<button><a href="newsignup.php">create an account</a></button>
