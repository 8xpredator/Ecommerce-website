...
?>
			...
			<ul class="list-inline list-unstyled">
				<li><a href="index33.php"><b>Home</b></a></li>
				<li><b>/</b></li>
...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>">
                    <img class="img-responsive" alt="" src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" width="370" height="350" />
                </a>
            </div>
...
<?php } ?>
							<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label"><font color=black size=2>Availability :</font></span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label"><font color=black size=2>Product Brand :</font></span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label"><font color=black size=2>Shipping Charge :</font></span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">
											<span class="label"><font color=black size=2>Amount&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        :</font></span>
