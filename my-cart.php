	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li><b>/</b></li>
				<li class='active'><b>Shopping Cart</b></li>
			</ul>
...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered" border="3">
			<thead>
				<tr bgcolor="#337ab7">
					<th class="cart-romove item"><b><font color="white">Remove</font></b></th>
					<th class="cart-description item"><b><font color="white">Image</font></b></th>
					<th class="cart-product-name item"><b><font color="white">Product Name</font></b></th>
			
					<th class="cart-qty item"><b><font color="white">Quantity</font></b></th>
					<th class="cart-sub-total item"><b><font color="white">Price Per unit</font></b></th>
					<th class="cart-sub-total item"><b><font color="white">Shipping Charge</font></b></th>
					<th class="cart-total last-item"><b><font color="white">Grandtotal</font></b></th>
				</tr>
			</thead><!-- /thead -->
			<tfoot>
				<tr>
