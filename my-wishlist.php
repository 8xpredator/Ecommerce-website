...
?>
				...
				<tr>
					<td class="col-md-2"><img src="admin/productimages/<?php echo htmlentities($row['pid']);?>/<?php echo htmlentities($row['pimage']);?>" alt="admin/productimages/<?php echo htmlentities($row['proid']);?>/<?php echo htmlentities($row['pimage']);?>" width="60" height="100"></td>
					<td class="col-md-6">
